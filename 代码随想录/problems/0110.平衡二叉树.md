...
防止多次求高度：用了左右子树高度才判断是否平衡，而不是判断左右子树平衡后再求高度
...
在[104.二叉树的最大深度](https://programmercarl.com/0104.二叉树的最大深度.html)中我们==<u>可以使用层序遍历来求深度，但是就不能直接用层序遍历来求高度了，这就体现出求高度和求深度的不同</u>==。
...
通过本题可以了解求二叉树深度 和 二叉树高度的差异，==求深度适合用前序(或**层序**)遍历，而求**高度**适合用后序遍历。==
